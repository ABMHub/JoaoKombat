...
#DESLOCAMENTO:		
	...
	bne t0, zero, S_FRAME1		# se t2!=0 então estamos na frame 1, do contrário estamos na frame 0

S_FRAME0: # é a frame 0
	...
	la a4, S_LARGURA_FRAME_0		# a4 = endereço da largura
	la a5, S_ALTURA_FRAME_0		# a5 = endereço da altura
	...
	li t0, 0xFF0FFFFF
	and a6, t0, s1
	la a4, S_LARGURA_FRAME_1		# a4 = endereço da largura
	la a5, S_ALTURA_FRAME_1		# a5 = endereço da altura
	#li a1, -1 			# da esquerda para direita
	...
	beq a2, zero, S_FIM_DESLOCAMENTO	# Todos os Frames foram pintados
	j S_DESLOCAMENTO			# ainda faltam frames a serem pintados
	
############################################################################################
S_FRAME1: # É a frame 1
