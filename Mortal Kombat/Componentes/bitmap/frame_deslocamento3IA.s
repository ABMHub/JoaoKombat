...
DESLOCAMENTO_IA:	
	...
	# Decisão_IA: frame 0 ou frame 1?
#DESLOCAMENTO_IA:		
	li t0, 0xFF200604
	lw t0, 0(t0)			# Descobre em que frame estamos
	
	bne t0, zero, FRAME1_IA		# se t2!=0 então estamos na frame 1, do contrário estamos na frame 0

FRAME0_IA: # é a frame 0
	...
	la a4, LARGURA_FRAME_0_IA	# a4 = endereço da largura
	la a5, ALTURA_FRAME_0_IA	# a5 = endereço da altura
	...
	beq a2, zero, FIM_DESLOCAMENTO_IA	# Todos os Frames foram pintados
	j DESLOCAMENTO_IA			# ainda faltam frames a serem pintados
	
############################################################################################
FRAME1_IA: # É a frame 1
